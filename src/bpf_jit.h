...
static inline bool is_creg(u8 reg) {
    return (1 << reg) & (BIT(RV_REG_FP) | BIT(RV_REG_S1) | BIT(RV_REG_A0) | BIT(RV_REG_A1) | BIT(RV_REG_A2) | BIT(RV_REG_A3) | BIT(RV_REG_A4) | BIT(RV_REG_A5));
}
...
static inline u32 rv_b_insn(u16 imm12_1, u8 rs2, u8 rs1, u8 funct3, u8 opcode) {
    ...
    return (imm12 << 25) | (rs2 << 20) | (rs1 << 15) | (funct3 << 12) | (imm4_1 << 7) | opcode;
}
...
static inline u32 rv_j_insn(u32 imm20_1, u8 rd, u8 opcode) {
    ...
    imm = (imm20_1 & 0x80000) | ((imm20_1 & 0x3ff) << 9) | ((imm20_1 & 0x400) >> 2) | ((imm20_1 & 0x7f800) >> 11);
...
static inline u16 rv_cl_insn(u8 funct3, u32 imm_hi, u8 rs1, u32 imm_lo, u8 rd,
                             u8 op) {
    return (funct3 << 13) | (imm_hi << 10) | ((rs1 & 0x7) << 7) | (imm_lo << 5) | ((rd & 0x7) << 2) | op;
}

static inline u16 rv_cs_insn(u8 funct3, u32 imm_hi, u8 rs1, u32 imm_lo, u8 rs2,
                             u8 op) {
    return (funct3 << 13) | (imm_hi << 10) | ((rs1 & 0x7) << 7) | (imm_lo << 5) | ((rs2 & 0x7) << 2) | op;
}

static inline u16 rv_ca_insn(u8 funct6, u8 rd, u8 funct2, u8 rs2, u8 op) {
    return (funct6 << 10) | ((rd & 0x7) << 7) | (funct2 << 5) | ((rs2 & 0x7) << 2) | op;
}
...
static inline u16 rvc_addi4spn(u8 rd, u32 imm10) {
    ...
    imm = ((imm10 & 0x30) << 2) | ((imm10 & 0x3c0) >> 4) | ((imm10 & 0x4) >> 1) | ((imm10 & 0x8) >> 3);
...
static inline u16 rvc_addi16sp(u32 imm10) {
    ...
    imm = ((imm10 & 0x200) >> 4) | (imm10 & 0x10) | ((imm10 & 0x40) >> 3) | ((imm10 & 0x180) >> 6) | ((imm10 & 0x20) >> 5);
...
static inline void emit_addi(u8 rd, u8 rs, s32 imm,
    ...
    else if (rvc_enabled() && is_creg(rd) && rs == RV_REG_SP && is_10b_uint(imm) && !(imm & 0x3) && imm)
